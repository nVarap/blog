...
---
# Section 1: Establishing the table
```
{
...
Uses **th**, **td**, and **tr** to create a table

# Section 2: GET from the endpoint
```
{
...
```
This section sets upt he headers and the credentials. This is where you'd put any rapid API keys
...
<mark>This actually fetches the information and makes sure it was retrieved successfully</mark>
```
{
          // World Data
...
# Section 3: Actually setting up the table
...
Uses element creation and appends elements to table.